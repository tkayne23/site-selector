...
define([], function () {
    return {
        ...
        Workflows: [{
            ...
            FilterSettings: {
                BusinesSortOptions: {
                    Option: "Count,Revenue,Employees"
                },
                FilterRangeFields: [{
        ...
        MapSharingOptions: {
            ...
            FacebookShareURL: "https://www.facebook.com/sharer.php?u=${0}&t=Site%20Selector",
            TwitterShareURL: "https://mobile.twitter.com/compose/tweet?status=Site%20Selector ${0}",
